...
const BentoTilt = ({children, className = ''}) => {
    ...
    const handleMouseMove = (e) => {
        ...
        const relativeX = (e.clientX - left) / width;  //give relative position of mouse to the position of card.
    ...
    return (
        ...
        ref={itemRef} onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave}
